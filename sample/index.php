...
<body>
	...
	<h1><?php echo "Hello ".($_ENV["NAME"]?$_ENV["NAME"]:"Hello StartCon Sydney 2016 from Microsoft Azure, care of Jenkins, VS Code, Kubernetes on Azure Container Service & Azure Container Registry!")."!"; ?></h1>
