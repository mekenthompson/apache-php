...
<body>
	...
	<h1><?php echo "Hi ".($_ENV["NAME"]?$_ENV["NAME"]:"StartCon Sydney 2016 from Microsoft Azure! Care of Bitnami, Jenkins, VS Code, Kubernetes on Azure Container Service & Azure Container Registry!")."!"; ?></h1>
